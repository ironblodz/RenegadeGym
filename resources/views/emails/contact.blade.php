                                                ...
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tbody>
                                                        <tr valign="top">
                                                            <td width="30"><p style="margin:0; font-size:1px; line-height:1px;">&nbsp;</p></td>
                                                            <td>
                                                                <p style="margin:0 0 4px; font-weight:bold; color:#333333; font-size:14px; line-height:22px;">Renegade Gym</p>
                                                                <p style="margin:0; color:#333333; font-size:11px; line-height:18px;">
                                                                    Rua Álvaro Pires Miranda, Leiria<br>
                                                                    Website: <a href="http://renegadegym.test/" style="color:#dc3545; text-decoration:none; font-weight:bold;">renegadegym.test</a>
                                                                </p>
                                                            </td>
