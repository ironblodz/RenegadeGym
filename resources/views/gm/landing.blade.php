         ...
         <div class="container--">
           <div class="row">
             <div class="col-lg-6 form">
               ...
               <form action="">
                 <label id="nomef" for="fname">Nome</label><br>
                 <input type="text" id="fname" name="fname"><br>
                 <label id="maill" for="lname">Email:</label><br>
                 <input type="email" id="lnamee" name="lname"><br>
                 <label for="lname">Contacto</label><br>
                 <input type="tel" id="lname" name="lname"><br>
         ...
         <div class="container--">
           <div class="row">
             <div id="mapa" class="col-12">
               ...
               <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d49077.69065862598!2d-8.840978083648444!3d39.7541222256194!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd22731534c9b2b9%3A0x4daf832739d43c6c!2sLeiria!5e0!3m2!1spt-PT!2spt!4v1634769549954!5m2!1spt-PT!2spt" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
             </div> 
           </div>
         </div>
       </section>
